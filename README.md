...
Unzip the compressed file and upload file `master.zip` into `app/i18n/Mageplaza/zh_hant_tw/zh_Hant_TW.csv`

See this screenshot

![Chinese Taiwan pack](https://cdn2.mageplaza.com/media/general2/tS668yC.png)
