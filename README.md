...
![Chinese Taiwan language pack process](https://progress-bar.dev//?title=completed)
...
```
composer require mageplaza/magento-2-chinese-taiwan-language-pack:dev-master avada/module-proofo
