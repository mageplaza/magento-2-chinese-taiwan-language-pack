...
2. [Install Chinese Taiwan Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Chinese Taiwan language pack](#3-how-to-active-hungarian-language-pack)
...
```
unzip master.zip app/i18n/Mageplaza/zh_hant_tw
```
...
Unzip the compressed file and upload file `zh_Hant_TW.zip` into `app/i18n/mageplaza/zh_Hant_TW/zh_Hant_TW.csv`
...
## 3. How to active Chinese Taiwan language pack {#active}
